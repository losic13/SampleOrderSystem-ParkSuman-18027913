...
| 3 | 도메인 모델 (`model/`) — GREEN | `03-domain-model-plan.md` | ⬜ 진행 중 |
| 3 | 도메인 모델 (`model/`) — REVIEW | `03-domain-model-plan.md` | ⬜ 대기 |
| 4 | JSON 저장소 계층 (`repository/`) | `04-repository-plan.md` | ⬜ 대기 |
| 5 | 시료/주문 컨트롤러 (`controller/sample_,order_`) | `05-controller-plan.md` | ⬜ 대기 |
